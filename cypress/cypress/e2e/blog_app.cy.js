    ...
    describe('when one blog is added', function() {
      ...
      describe('when multiple blogs have been added', function() {
        ...
        it('the order of the blogs changes when likes change', function() {
          cy.get('.blogStyle').contains('Kolmas otsikko').contains('view').click()
          cy.get('.blogStyle').contains('Kolmas otsikko').get('.moreSpecificInfo').contains("likes: 425").parent().find('.likeButton').click().click()
          cy.wait(1000)
          cy.get('.blogStyle').contains('Kolmas otsikko').get('.moreSpecificInfo').contains("likes: 427")
